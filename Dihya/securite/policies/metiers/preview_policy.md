...
## Objectif
Définir les règles d’accès, d’audit, de conformité et d’extension pour la gestion des previews dans Dihya.
...
## Cas d’usage
- Consultation de previews
- Partage de snapshots
...
- `POST /api/preview/partage`
- `DELETE /api/preview/snapshot/{id}`
