# Ressources Humaines – ABAC Policy
...
## Description
Politique d’accès basée sur les attributs (ABAC) pour la gestion RH dans Dihya. Contrôle fin selon le rôle, le contexte, la conformité RGPD, et la localisation.
...
```python
"""
Vérification d’accès RH (ABAC)
:param user: dict (doit contenir role, tenant, gdpr_consent)
:param action: str
:param resource: str
:return: bool
"""
def check_rh_access(user: dict, action: str, resource: str) -> bool:
    # ...existing code...
