...
from Dihya.backend.compliance.rgpd.export_rgpd import router as rgpd_router, RGPDExportRequest, RGPDDeleteRequest, RGPDConsentRequest, Role, RGPDExportFormat
from Dihya.backend.compliance.reports.badge_conformite import generer_badge_conformite
from Dihya.backend.compliance.provenance.log_provenance import log_provenance_router
...
def app():
    ...
    app.include_router(log_provenance_router, prefix="/api/provenance")
    return app
...
def test_workflow_conformite_e2e(client, tmp_path):
    ...
    from Dihya.backend.compliance.rgpd.export_rgpd import RGPDPolicy
    class DummyPlugin:
    ...
    from Dihya.backend.compliance.rgpd.export_rgpd import log_audit
    try:
