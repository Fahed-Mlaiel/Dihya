...
import strawberry
from .log_provenance import ProvenanceLogger, ProvenanceExportRequest, ProvenanceExportResponse

@strawberry.type
class Mutation:
    @strawberry.mutation
    def export_provenance(self, input: ProvenanceExportRequest) -> ProvenanceExportResponse:
        return ProvenanceLogger().export(input)
