# Integrationstests für das Modul "medias" (Ultra-Advanced)
...
## Ausführung
```bash
pytest test_medias_flask.py
```

## Beispiel-Testfälle
- GET /api/medias/?lang=de (Multilingual)
- POST /api/medias/ (RBAC, Admin only)
- DELETE /api/medias/1 (RGPD, Audit)
- /api/medias/plugin/sample (Plugin)
- /api/medias/graphql (GraphQL)
