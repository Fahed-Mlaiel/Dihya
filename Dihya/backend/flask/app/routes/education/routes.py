"""
Routes RESTful & GraphQL pour l'éducation (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets éducation (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet éducation (validation, RGPD, fallback IA, audit)."""
    data = request.json
