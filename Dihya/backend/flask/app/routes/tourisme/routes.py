"""
Routes RESTful & GraphQL pour le tourisme (IA, VR, AR, etc.)
...
bp = Blueprint('tourisme', __name__, url_prefix='/api/tourisme')

@bp.route('/projects', methods=['GET'])
@jwt_required()
# ...@require_role(['admin', 'user'])...
def list_projects():
    """Liste les projets tourisme (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet tourisme (validation, RGPD, fallback IA, audit)."""
    data = request.json
