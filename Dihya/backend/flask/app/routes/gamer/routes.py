"""
Routes RESTful & GraphQL pour le gaming (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets gaming (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet gaming (validation, RGPD, fallback IA, audit)."""
    data = request.json
