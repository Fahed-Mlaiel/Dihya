...
bp = Blueprint('intelligence_artificielle', __name__, url_prefix='/api/ia')
...
from .schema import ia_schema
bp.add_url_rule('/graphql', view_func=GraphQLView.as_view('graphql', schema=ia_schema, graphiql=True))
