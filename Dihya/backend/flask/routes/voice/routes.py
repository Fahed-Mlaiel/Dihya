...
def list_projects_voice() -> Any:
    """Lister les projets voice/IA vocale (multitenancy, i18n, audit, plugins)."""
...
def create_project_voice() -> Any:
    """Créer un projet voice/IA vocale (validation, audit, plugins, RGPD)."""
    user = get_jwt_identity()
    # TODO: Validation, audit, plugins, fallback IA
    return jsonify({'msg': 'Projet voice/IA vocale créé'}), 201
