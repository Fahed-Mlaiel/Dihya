...
const { validateSecuriteInput } = require('../../validators/securite');
const { getSecuriteData, createSecuriteEntry, updateSecuriteEntry, deleteSecuriteEntry } = require('../../controllers/securite');
...
router.use('/plugin', pluginManager('securite'));
