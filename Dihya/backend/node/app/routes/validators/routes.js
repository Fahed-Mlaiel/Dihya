...
const { validateValidatorsInput } = require('../../validators/validators');
const { getValidatorsData, createValidatorsEntry, updateValidatorsEntry, deleteValidatorsEntry } = require('../../controllers/validators');
...
router.use('/plugin', pluginManager('validators'));
