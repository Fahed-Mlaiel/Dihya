...
const { validateVoiceInput } = require('../../validators/voice');
const { getVoiceData, createVoiceEntry, updateVoiceEntry, deleteVoiceEntry } = require('../../controllers/voice');
...
router.use('/plugin', pluginManager('voice'));
