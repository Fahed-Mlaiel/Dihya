...
const { validateTransportInput } = require('../../validators/transport');
const { getTransportData, createTransportEntry, updateTransportEntry, deleteTransportEntry } = require('../../controllers/transport');
...
router.use('/plugin', pluginManager('transport'));
