...
const { validateRHInput } = require('../../validators/ressources_humaines');
const { getRHData, createRHEntry, updateRHEntry, deleteRHEntry } = require('../../controllers/ressources_humaines');
...
router.use('/plugin', pluginManager('ressources_humaines'));
