...
const { validateMobileInput } = require('../../validators/mobile');
const { getMobileData, createMobileEntry, updateMobileEntry, deleteMobileEntry } = require('../../controllers/mobile');
...
router.use('/plugin', pluginManager('mobile'));
